...
The 'gpt-4' model is used by default. To use a different model, set the name of the model in an R environmental variable called 'OPENAI\_MODEL' (see previous section for instructions on setting an environmental variable).
