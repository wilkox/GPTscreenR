...
The file `r Solastalgia re-screening and extraction spreadsheet Dec 2022.xlsx` was downloaded on 16 May 2023.
...
```{r}
sources <- screen_sources(sources, study_description, n = 15,
