---
title: GPTScreenR validation - COVID-19 misinformation study
...
`r sources %>% filter(human_recommendation == "Maybe"` sources had 'Maybe' as the human recommendation. These will be removed, as GPTscreenR is designed to provide only a binary include/exclude decision.
...
A `r sources %>`mysterious number of sources had 'No DOI', these will be removed.
...
sources <- screen_sources(sources, study_description, n = 25,
